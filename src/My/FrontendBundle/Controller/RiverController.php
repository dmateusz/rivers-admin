...
class RiverController extends Controller
{
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MyFrontendBundle:River')->find($id);
    ...
    {
        $entity = new River();
        $form   = $this->createForm(new RiverType(), $entity);
     ...
     *
     * @Route("/create", name="river_create")
     * @Method("POST")
     * @Template("MyFrontendBundle:River:new.html.twig")
     */
    ...
    public function editAction($id)
    {
        ...
        $editForm = $this->createForm(new RiverType(), $entity);
        $deleteForm = $this->createDeleteForm($id);
     ...
     *
     * @Route("/{id}/update", name="river_update")
     * @Method("POST")
     * @Template("MyFrontendBundle:River:edit.html.twig")
     */
     ...
     *
     * @Route("/{id}/delete", name="river_delete")
     * @Method("POST")
     */
